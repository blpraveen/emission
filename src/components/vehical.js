...
class Vehical extends React.Component {
    constructor() {
        super();
    ...
    render() {
        ...
        <div className="body-top">
            <h2 className="title"><img className="symbol" src={symbol} />Vehical Class</h2>
            <p className="sub-title">Class of the vehical depending on their utility,capacity and weight</p>
        </div>
        <div className="row">
            <div className="body-column">
                <div className="body-full margin-card">
                    <div className="column-div-left"><span className="type-class-1">SUV- Small</span></div>
                    <div className="column-div-right"><span className="val-perc">16%</span>
                    </div>
                </div>
                <div className="body-full margin-card">
                    <div className="column-div-left"><span className="type-class-1">Mid-Size</span></div>
                    <div className="column-div-right"><span className="val-perc">15%</span>
                    </div>
                </div>
                <div className="body-full margin-card">
                    <div className="column-div-left val-color">Others (5035)</div>
                    <div className="column-div-right val-color"><span className="val-perc">68%</span>
                    </div>
                </div>
            </div>
            <div className="body-column">
                ...
                <div className="body-full-2 body-full">
                    ...
                    <div className="column-div2-right1"><span className="val-perc">16</span></div>
                    <div className="column-div2-right2"><span className="val-perc val-color">0%</span>
                    </div>
                </div>
                <div className="body-full-2 body-full">
                    ...
                    <div className="column-div2-right1"><span className="val-perc">SUV-SMALL</span></div>
                    <div className="column-div2-right2"><span className="val-perc val-color">0%</span>
                    </div>
                </div>
            </div>
